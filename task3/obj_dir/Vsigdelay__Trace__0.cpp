...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+7,(vlSelf->sigdelay__DOT__counter_addr),8);
    bufp->chgSData(oldp+8,(vlSelf->sigdelay__DOT__counter_addr),9);
    bufp->chgSData(oldp+9,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT__counter_addr) 
